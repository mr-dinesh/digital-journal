...
Meta-idea: Write about what you've done
(aside: why is this a meta-idea, will write about it later)

Today's idea: create a browser extension for a URL sanitizer. It removes all tracking parameters from the link before rendering it in a new tab. 
